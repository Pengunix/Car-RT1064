...
typedef struct _serial_nor_config_option {
  ...
  union {
    struct {
      ...
      uint32_t status_override : 8;  //!< Override status register value during
...
typedef struct {
  ...
  void (*CLOCK_SetPllBypass)(CCM_ANALOG_Type *base, clock_pll_t pll,
                             bool bypass);
...
void rom_api_CLOCK_SetPllBypass(CCM_ANALOG_Type *base, clock_pll_t pll,
                                bool bypass);
...
bool rom_api_CLOCK_EnableUsbhs0PhyPllClock(clock_usb_phy_src_t src,
                                           uint32_t freq);
...
bool rom_api_CLOCK_EnableUsbhs1PhyPllClock(clock_usb_phy_src_t src,
                                           uint32_t freq);
...
//-------------------------FlexSPI NOR
//--------------------------------------------
status_t rom_api_flexspi_nor_flash_init(uint32_t instance,
                                        flexspi_nor_config_t *config);
status_t rom_api_flexspi_nor_flash_page_program(uint32_t instance,
                                                flexspi_nor_config_t *config,
                                                uint32_t dstAddr,
                                                const uint32_t *src);
status_t rom_api_flexspi_nor_flash_erase_all(uint32_t instance,
                                             flexspi_nor_config_t *config);
status_t rom_api_flexspi_nor_get_config(uint32_t instance,
                                        flexspi_nor_config_t *config,
                                        serial_nor_config_option_t *option);
status_t rom_api_flexspi_nor_flash_erase(uint32_t instance,
                                         flexspi_nor_config_t *config,
                                         uint32_t start, uint32_t length);
status_t rom_api_flexspi_nor_flash_read(uint32_t instance,
                                        flexspi_nor_config_t *config,
                                        uint32_t *dst, uint32_t start,
                                        uint32_t bytes);
status_t rom_api_flexspi_update_lut(uint32_t instance, uint32_t seqIndex,
